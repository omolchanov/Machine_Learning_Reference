...
class Visualizer:
    ...
    """
    @staticmethod
    def visualize_nn_structure(model, description=False, figsize=(10, 8)):
        # get layers info
        lst_layers = Visualizer._utils_nn_config(model)
    ...
    """
    Visualizing the training results: test and train fractions of the dataset
    """
    @staticmethod
    def visualize_training_results(training):
        # plot
